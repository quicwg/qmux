...
not use ACK frames. In contrast to QUIC version 1 that tracks delivery of frames
and retransmit lost information ({{Section 13.3 of QUIC}}), frames in QMux are
